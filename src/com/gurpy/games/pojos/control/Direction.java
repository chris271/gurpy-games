...
public class Direction {
    ...
    public static final double UP_LEFT = Math.toRadians(225);
    public static final double UP = Math.toRadians(270);
    public static final double UP_RIGHT = Math.toRadians(315);
}
